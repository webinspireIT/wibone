 ...
 * Licensed under MIT (https://github.com/twbs/bootstrap/blob/master/LICENSE)
 * ======================================================================== */
 +function(a){function h(c){return this.each(function(){var m=a(this),d=m.data("bs.carousel"),e=a.extend({},b.DEFAULTS,m.data(),"object"==typeof c&&c),f="string"==typeof c?c:e.slide;d||m.data("bs.carousel",d=new b(this,e));if("number"==typeof c)d.to(c);else if(f)d[f]();else e.interval&&d.pause().cycle()})}var b=function(c,b){this.$element=a(c);this.$indicators=this.$element.find(".carousel-indicators");this.options=b;this.$items=this.$active=this.interval=this.sliding=this.paused=null;this.options.keyboard&&
...
break;default:return}c.preventDefault()}};b.prototype.cycle=function(c){c||(this.paused=!1);this.interval&&clearInterval(this.interval);this.options.interval&&!this.paused&&(this.interval=setInterval(a.proxy(this.next,this),this.options.interval));return this};b.prototype.getItemIndex=function(c){this.$items=c.parent().children(".item");return this.$items.index(c||this.$active)};b.prototype.getItemForDirection=function(c,a){var d=this.getItemIndex(a);return("prev"==c&&0===d||"next"==c&&d==this.$items.length-
1)&&!this.options.wrap?a:this.$items.eq((d+("prev"==c?-1:1))%this.$items.length)};b.prototype.to=function(a){var b=this,d=this.getItemIndex(this.$active=this.$element.find(".item.active"));if(!(a>this.$items.length-1||0>a))return this.sliding?this.$element.one("slid.bs.carousel",function(){b.to(a)}):d==a?this.pause().cycle():this.slide(a>d?"next":"prev",this.$items.eq(a))};b.prototype.pause=function(c){c||(this.paused=!0);this.$element.find(".next, .prev").length&&a.support.transition&&(this.$element.trigger(a.support.transition.end),
this.cycle(!0));this.interval=clearInterval(this.interval);return this};b.prototype.next=function(){if(!this.sliding)return this.slide("next")};b.prototype.prev=function(){if(!this.sliding)return this.slide("prev")};b.prototype.slide=function(c,f){var d=this.$element.find(".item.active"),e=f||this.getItemForDirection(c,d),g=this.interval,k="next"==c?"left":"right",h=this;if(e.hasClass("active"))return this.sliding=!1;var n=e[0],l=a.Event("slide.bs.carousel",{relatedTarget:n,direction:k});this.$element.trigger(l);
if(!l.isDefaultPrevented()){this.sliding=!0;g&&this.pause();this.$indicators.length&&(this.$indicators.find(".active").removeClass("active"),(l=a(this.$indicators.children()[this.getItemIndex(e)]))&&l.addClass("active"));var p=a.Event("slid.bs.carousel",{relatedTarget:n,direction:k});a.support.transition&&this.$element.hasClass("slide")?(e.addClass(c),e[0].offsetWidth,d.addClass(k),e.addClass(k),d.one("bsTransitionEnd",function(){e.removeClass([c,k].join(" ")).addClass("active");d.removeClass(["active",
k].join(" "));h.sliding=!1;setTimeout(function(){h.$element.trigger(p)},0)}).emulateTransitionEnd(b.TRANSITION_DURATION)):(d.removeClass("active"),e.addClass("active"),this.sliding=!1,this.$element.trigger(p));g&&this.cycle();return this}};var g=a.fn.carousel;a.fn.carousel=h;a.fn.carousel.Constructor=b;a.fn.carousel.noConflict=function(){a.fn.carousel=g;return this};var f=function(c){var b,d=a(this),e=a(d.attr("data-target")||(b=d.attr("href"))&&b.replace(/.*(?=#[^\s]+$)/,""));if(e.hasClass("carousel")){b=
a.extend({},e.data(),d.data());if(d=d.attr("data-slide-to"))b.interval=!1;h.call(e,b);d&&e.data("bs.carousel").to(d);c.preventDefault()}};a(document).on("click.bs.carousel.data-api","[data-slide]",f).on("click.bs.carousel.data-api","[data-slide-to]",f);a(window).on("load",function(){a('[data-ride="carousel"]').each(function(){var b=a(this);h.call(b,b.data())})})}(jQuery);
 ...
 * Licensed under MIT (https://github.com/twbs/bootstrap/blob/master/LICENSE)
 * ======================================================================== */
+function(c){function f(a){return this.each(function(){var b=c(this),e=b.data("bs.button"),g="object"==typeof a&&a;e||b.data("bs.button",e=new d(this,g));"toggle"==a?e.toggle():a&&e.setState(a)})}var d=function(a,b){this.$element=c(a);this.options=c.extend({},d.DEFAULTS,b);this.isLoading=!1};d.VERSION="3.3.4";d.DEFAULTS={loadingText:"loading..."};d.prototype.setState=function(a){var b=this.$element,e=b.is("input")?"val":"html",d=b.data();a+="Text";null==d.resetText&&b.data("resetText",b[e]());setTimeout(c.proxy(function(){b[e](null==
...
!this.$element.hasClass("active"));a&&this.$element.toggleClass("active")};var h=c.fn.button;c.fn.button=f;c.fn.button.Constructor=d;c.fn.button.noConflict=function(){c.fn.button=h;return this};c(document).on("click.bs.button.data-api",'[data-toggle^="button"]',function(a){var b=c(a.target);b.hasClass("wi-btn")||(b=b.closest(".wi-btn"));f.call(b,"toggle");a.preventDefault()}).on("focus.bs.button.data-api blur.bs.button.data-api",'[data-toggle^="button"]',function(a){c(a.target).closest(".wi-btn").toggleClass("focus",
/^focus(in)?$/.test(a.type))})}(jQuery);


/**
 * placeholder.js v2.0.8
...
(function(c){function x(a){if(w||a)w&&a&&(c(document).unbind(".smartmenus_mouse"),w=!1);else{var b=!0,e=null;c(document).bind(r([["mousemove",function(a){var f={x:a.pageX,y:a.pageY,timeStamp:(new Date).getTime()};if(e){var g=Math.abs(e.x-f.x),h=Math.abs(e.y-f.y);if((0<g||0<h)&&2>=g&&2>=h&&300>=f.timeStamp-e.timeStamp&&(m=!0,b)){var k=c(a.target).closest("a");k.is("a")&&c.each(n,function(){if(c.contains(this.$root[0],k[0]))return this.itemEnter({currentTarget:k[0]}),!1});b=!1}}e=f}],["ontouchstart"in window?"touchstart":"pointerover pointermove pointerout MSPointerOver MSPointerMove MSPointerOut",function(a){/^(4|mouse)$/.test(a.originalEvent.pointerType)||(m=!1)}]],".smartmenus_mouse"));w=!0}}function r(a,b){b||(b="");var e={};c.each(a,function(a,c){e[c[0].split(" ").join(b+" ")+b]=c[1]});return e}var n=[],y=!!window.createPopup,m=!1,w=!1;c.SmartMenus=function(a,b){this.$root=c(a);this.opts=b;this.rootId="";this.$subArrow=null;this.subMenus=[];this.activatedItems=[];this.visibleSubMenus=[];this.scrollTimeout= this.hideTimeout=this.showTimeout=0;this.clickActivated=!1;this.zIndexInc=0;this.$firstSub=this.$firstLink=null;this.disabled=!1;this.$disableOverlay=null;this.isTouchScrolling=!1;this.init()};c.extend(c.SmartMenus,{hideAll:function(){c.each(n,function(){this.menuHideAll()})},destroy:function(){for(;n.length;)n[0].destroy();x(!0)},prototype:{init:function(a){var b=this;a||(n.push(this),this.rootId=((new Date).getTime()+Math.random()+"").replace(/\D/g,""),this.$root.hasClass("sm-rtl")&&(this.opts.rightToLeftSubMenus= !0),a=".smartmenus",this.$root.data("smartmenus",this).attr("data-smartmenus-id",this.rootId).dataSM("level",1).bind(r([["mouseover focusin",c.proxy(this.rootOver,this)],["mouseout focusout",c.proxy(this.rootOut,this)]],a)).delegate("a",r([["mouseenter",c.proxy(this.itemEnter,this)],["mouseleave",c.proxy(this.itemLeave,this)],["mousedown",c.proxy(this.itemDown,this)],["focus",c.proxy(this.itemFocus,this)],["blur",c.proxy(this.itemBlur,this)],["click",c.proxy(this.itemClick,this)],["touchend",c.proxy(this.itemTouchEnd, this)]],a)),a+=this.rootId,this.opts.hideOnClick&&c(document).bind(r([["touchstart",c.proxy(this.docTouchStart,this)],["touchmove",c.proxy(this.docTouchMove,this)],["touchend",c.proxy(this.docTouchEnd,this)],["click",c.proxy(this.docClick,this)]],a)),c(window).bind(r([["resize orientationchange",c.proxy(this.winResize,this)]],a)),this.opts.subIndicators&&(this.$subArrow=c("<span/>").addClass("sub-arrow"),this.opts.subIndicatorsText&&this.$subArrow.html(this.opts.subIndicatorsText)),x());this.$firstSub= this.$root.find("ul").each(function(){b.menuInit(c(this))}).eq(0);this.$firstLink=this.$root.find("a").eq(0);if(this.opts.markCurrentItem){var e=/(index|default)\.[^#\?\/]*/i,d=window.location.href.replace(e,""),f=d.replace(/#.*/,"");this.$root.find("a").each(function(){var a=this.href.replace(e,""),h=c(this);if(a==d||a==f)h.addClass("current"),b.opts.markCurrentTree&&h.parent().parentsUntil("[data-smartmenus-id]","li").children("a").addClass("current")})}},destroy:function(){this.menuHideAll();var a= ".smartmenus";this.$root.removeData("smartmenus").removeAttr("data-smartmenus-id").removeDataSM("level").unbind(a).undelegate(a);a+=this.rootId;c(document).unbind(a);c(window).unbind(a);this.opts.subIndicators&&(this.$subArrow=null);var b=this;c.each(this.subMenus,function(){this.hasClass("mega-menu")&&this.find("ul").removeDataSM("in-mega");this.dataSM("shown-before")&&((b.opts.subMenusMinWidth||b.opts.subMenusMaxWidth)&&this.css({width:"",minWidth:"",maxWidth:""}).removeClass("sm-nowrap"),this.dataSM("scroll-arrows")&& this.dataSM("scroll-arrows").remove(),this.css({zIndex:"",top:"",left:"",marginLeft:"",marginTop:"",display:""}));b.opts.subIndicators&&this.dataSM("parent-a").removeClass("has-submenu").children("span.sub-arrow").remove();this.removeDataSM("shown-before").removeDataSM("ie-shim").removeDataSM("scroll-arrows").removeDataSM("parent-a").removeDataSM("level").removeDataSM("beforefirstshowfired").parent().removeDataSM("sub")});this.opts.markCurrentItem&&this.$root.find("a.current").removeClass("current"); this.$firstSub=this.$firstLink=this.$root=null;this.$disableOverlay&&(this.$disableOverlay.remove(),this.$disableOverlay=null);n.splice(c.inArray(this,n),1)},disable:function(a){this.disabled||(this.menuHideAll(),a||this.opts.isPopup||!this.$root.is(":visible")||(a=this.$root.offset(),this.$disableOverlay=c('<div class="sm-jquery-disable-overlay"/>').css({position:"absolute",top:a.top,left:a.left,width:this.$root.outerWidth(),height:this.$root.outerHeight(),zIndex:this.getStartZIndex(!0),opacity:0}).appendTo(document.body)), this.disabled=!0)},docClick:function(a){this.isTouchScrolling?this.isTouchScrolling=!1:(this.visibleSubMenus.length&&!c.contains(this.$root[0],a.target)||c(a.target).is("a"))&&this.menuHideAll()},docTouchEnd:function(a){if(this.lastTouch){if(!(!this.visibleSubMenus.length||void 0!==this.lastTouch.x2&&this.lastTouch.x1!=this.lastTouch.x2||void 0!==this.lastTouch.y2&&this.lastTouch.y1!=this.lastTouch.y2||this.lastTouch.target&&c.contains(this.$root[0],this.lastTouch.target))){this.hideTimeout&&(clearTimeout(this.hideTimeout), this.hideTimeout=0);var b=this;this.hideTimeout=setTimeout(function(){b.menuHideAll()},350)}this.lastTouch=null}},docTouchMove:function(a){this.lastTouch&&(a=a.originalEvent.touches[0],this.lastTouch.x2=a.pageX,this.lastTouch.y2=a.pageY)},docTouchStart:function(a){a=a.originalEvent.touches[0];this.lastTouch={x1:a.pageX,y1:a.pageY,target:a.target}},enable:function(){this.disabled&&(this.$disableOverlay&&(this.$disableOverlay.remove(),this.$disableOverlay=null),this.disabled=!1)},getClosestMenu:function(a){for(a= c(a).closest("ul");a.dataSM("in-mega");)a=a.parent().closest("ul");return a[0]||null},getHeight:function(a){return this.getOffset(a,!0)},getOffset:function(a,b){var c;"none"==a.css("display")&&(c={position:a[0].style.position,visibility:a[0].style.visibility},a.css({position:"absolute",visibility:"hidden"}).show());var d=a[0].getBoundingClientRect&&a[0].getBoundingClientRect();(d=d&&(b?d.height||d.bottom-d.top:d.width||d.right-d.left))||0===d||(d=b?a[0].offsetHeight:a[0].offsetWidth);c&&a.hide().css(c); return d},getStartZIndex:function(a){var b=parseInt(this[a?"$root":"$firstSub"].css("z-index"));!a&&isNaN(b)&&(b=parseInt(this.$root.css("z-index")));return isNaN(b)?1:b},getTouchPoint:function(a){return a.touches&&a.touches[0]||a.changedTouches&&a.changedTouches[0]||a},getViewport:function(a){var b=a?"Height":"Width";a=document.documentElement["client"+b];(b=window["inner"+b])&&(a=Math.min(a,b));return a},getViewportHeight:function(){return this.getViewport(!0)},getViewportWidth:function(){return this.getViewport()}, getWidth:function(a){return this.getOffset(a)},handleEvents:function(){return!this.disabled&&this.isCSSOn()},handleItemEvents:function(a){return this.handleEvents()&&!this.isLinkInMegaMenu(a)},isCollapsible:function(){return"static"==this.$firstSub.css("position")},isCSSOn:function(){return"block"==this.$firstLink.css("display")},isFixed:function(){var a="fixed"==this.$root.css("position");a||this.$root.parentsUntil("body").each(function(){if("fixed"==c(this).css("position"))return a=!0,!1});return a}, isLinkInMegaMenu:function(a){return!a.parent().parent().dataSM("level")},isTouchMode:function(){return!m||this.isCollapsible()},itemActivate:function(a){var b=a.parent(),e=b.parent(),d=e.dataSM("level");if(1<d&&(!this.activatedItems[d-2]||this.activatedItems[d-2][0]!=e.dataSM("parent-a")[0])){var f=this;c(e.parentsUntil("[data-smartmenus-id]","ul").get().reverse()).add(e).each(function(){f.itemActivate(c(this).dataSM("parent-a"))})}this.visibleSubMenus.length>d&&this.menuHideSubMenus(this.activatedItems[d- 1]&&this.activatedItems[d-1][0]==a[0]?d:d-1);this.activatedItems[d-1]=a;this.visibleSubMenus[d-1]=e;!1!==this.$root.triggerHandler("activate.smapi",a[0])&&(a=b.dataSM("sub"))&&(this.isTouchMode()||!this.opts.showOnClick||this.clickActivated)&&this.menuShow(a)},itemBlur:function(a){a=c(a.currentTarget);this.handleItemEvents(a)&&this.$root.triggerHandler("blur.smapi",a[0])},itemClick:function(a){if(this.isTouchScrolling)return this.isTouchScrolling=!1,a.stopPropagation(),!1;a=c(a.currentTarget);if(this.handleItemEvents(a)){a.removeDataSM("mousedown"); if(!1===this.$root.triggerHandler("click.smapi",a[0]))return!1;var b=a.parent().dataSM("sub");if(this.isTouchMode()){if(a.dataSM("href")&&a.attr("href",a.dataSM("href")).removeDataSM("href"),b&&(!b.dataSM("shown-before")||!b.is(":visible"))&&(this.itemActivate(a),b.is(":visible")))return!1}else if(this.opts.showOnClick&&1==a.parent().parent().dataSM("level")&&b)return this.clickActivated=!0,this.menuShow(b),!1;if(a.hasClass("disabled")||!1===this.$root.triggerHandler("select.smapi",a[0]))return!1}}, itemDown:function(a){a=c(a.currentTarget);this.handleItemEvents(a)&&a.dataSM("mousedown",!0)},itemEnter:function(a){var b=c(a.currentTarget);if(this.handleItemEvents(b)){if(!this.isTouchMode()){this.showTimeout&&(clearTimeout(this.showTimeout),this.showTimeout=0);var e=this;this.showTimeout=setTimeout(function(){e.itemActivate(b)},this.opts.showOnClick&&1==b.parent().parent().dataSM("level")?1:this.opts.showTimeout)}this.$root.triggerHandler("mouseenter.smapi",b[0])}},itemFocus:function(a){a=c(a.currentTarget); this.handleItemEvents(a)&&(this.isTouchMode()&&a.dataSM("mousedown")||this.activatedItems.length&&this.activatedItems[this.activatedItems.length-1][0]==a[0]||this.itemActivate(a),this.$root.triggerHandler("focus.smapi",a[0]))},itemLeave:function(a){a=c(a.currentTarget);this.handleItemEvents(a)&&(this.isTouchMode()||(a[0].blur&&a[0].blur(),this.showTimeout&&(clearTimeout(this.showTimeout),this.showTimeout=0)),a.removeDataSM("mousedown"),this.$root.triggerHandler("mouseleave.smapi",a[0]))},itemTouchEnd:function(a){a= c(a.currentTarget);if(this.handleItemEvents(a)){var b=a.parent().dataSM("sub");"#"===a.attr("href").charAt(0)||!b||b.dataSM("shown-before")&&b.is(":visible")||(a.dataSM("href",a.attr("href")),a.attr("href","#"))}},menuFixLayout:function(a){a.dataSM("shown-before")||a.hide().dataSM("shown-before",!0)},menuHide:function(a){if(!1!==this.$root.triggerHandler("beforehide.smapi",a[0])&&(a.stop(!0,!0),a.is(":visible"))){var b=function(){a.css("z-index","")};this.isCollapsible()?this.opts.collapsibleHideFunction? this.opts.collapsibleHideFunction.call(this,a,b):a.hide(this.opts.collapsibleHideDuration,b):this.opts.hideFunction?this.opts.hideFunction.call(this,a,b):a.hide(this.opts.hideDuration,b);a.dataSM("ie-shim")&&a.dataSM("ie-shim").remove();a.dataSM("scroll")&&(this.menuScrollStop(a),a.css({"touch-action":"","-ms-touch-action":""}).unbind(".smartmenus_scroll").removeDataSM("scroll").dataSM("scroll-arrows").hide());a.dataSM("parent-a").removeClass("highlighted");b=a.dataSM("level");this.activatedItems.splice(b- 1,1);this.visibleSubMenus.splice(b-1,1);this.$root.triggerHandler("hide.smapi",a[0])}},menuHideAll:function(){this.showTimeout&&(clearTimeout(this.showTimeout),this.showTimeout=0);this.menuHideSubMenus();this.opts.isPopup&&(this.$root.stop(!0,!0),this.$root.is(":visible")&&(this.opts.hideFunction?this.opts.hideFunction.call(this,this.$root):this.$root.hide(this.opts.hideDuration),this.$root.dataSM("ie-shim")&&this.$root.dataSM("ie-shim").remove()));this.activatedItems=[];this.visibleSubMenus=[];this.clickActivated= !1;this.zIndexInc=0},menuHideSubMenus:function(a){a||(a=0);for(var b=this.visibleSubMenus.length-1;b>a;b--)this.menuHide(this.visibleSubMenus[b])},menuIframeShim:function(a){y&&this.opts.overlapControlsInIE&&!a.dataSM("ie-shim")&&a.dataSM("ie-shim",c("<iframe/>").attr({src:"javascript:0",tabindex:-9}).css({position:"absolute",top:"auto",left:"0",opacity:0,border:"0"}))},menuInit:function(a){if(!a.dataSM("in-mega")){this.subMenus.push(a);a.hasClass("mega-menu")&&a.find("ul").dataSM("in-mega",!0);for(var b= 2,c=a[0];(c=c.parentNode.parentNode)!=this.$root[0];)b++;a.dataSM("parent-a",a.prevAll("a").eq(-1)).dataSM("level",b).parent().dataSM("sub",a);this.opts.subIndicators&&a.dataSM("parent-a").addClass("has-submenu")}},menuPosition:function(a){var b=a.dataSM("parent-a"),e=a.parent().parent(),d=a.dataSM("level"),f=this.getWidth(a),g=this.getHeight(a),h=b.offset(),k=h.left,q=h.top,h=this.getWidth(b),b=this.getHeight(b),p=c(window),m=p.scrollLeft(),p=p.scrollTop(),n=this.getViewportWidth(),u=this.getViewportHeight(), e=e.hasClass("sm")&&!e.hasClass("sm-vertical"),v=2==d?this.opts.mainMenuSubOffsetX:this.opts.subMenusSubOffsetX,l=2==d?this.opts.mainMenuSubOffsetY:this.opts.subMenusSubOffsetY;e?(d=this.opts.rightToLeftSubMenus?h-f-v:v,l=this.opts.bottomToTopSubMenus?-g-l:b+l):(d=this.opts.rightToLeftSubMenus?v-f:h-v,l=this.opts.bottomToTopSubMenus?b-l-g:l);if(this.opts.keepInViewport&&!this.isCollapsible()){k+=d;q+=l;this.opts.rightToLeftSubMenus&&k<m?d=e?m-k+d:h-v:!this.opts.rightToLeftSubMenus&&k+f>m+n&&(d=e? m+n-f-k+d:v-f);if(!e)if(g<u&&q+g>p+u)l+=p+u-g-q;else if(g>=u||q<p)l+=p-q;if(e&&(q+g>p+u+.49||q<p)||!e&&g>u+.49){var t=this;a.dataSM("scroll-arrows")||a.dataSM("scroll-arrows",c([c('<span class="scroll-up"><span class="scroll-up-arrow"></span></span>')[0],c('<span class="scroll-down"><span class="scroll-down-arrow"></span></span>')[0]]).bind({mouseenter:function(){a.dataSM("scroll").up=c(this).hasClass("scroll-up");t.menuScroll(a)},mouseleave:function(b){t.menuScrollStop(a);t.menuScrollOut(a,b)},"mousewheel DOMMouseScroll":function(a){a.preventDefault()}}).insertAfter(a)); a.dataSM("scroll",{step:1,itemH:b,subH:g,arrowDownH:this.getHeight(a.dataSM("scroll-arrows").eq(1))}).bind(r([["mouseover",function(b){t.menuScrollOver(a,b)}],["mouseout",function(b){t.menuScrollOut(a,b)}],["mousewheel DOMMouseScroll",function(b){t.menuScrollMousewheel(a,b)}]],".smartmenus_scroll")).dataSM("scroll-arrows").css({top:"auto",left:"0",marginLeft:d+(parseInt(a.css("border-left-width"))||0),width:f-(parseInt(a.css("border-left-width"))||0)-(parseInt(a.css("border-right-width"))||0),zIndex:a.css("z-index")}).eq(e&& this.opts.bottomToTopSubMenus?0:1).show();this.isFixed()&&a.css({"touch-action":"none","-ms-touch-action":"none"}).bind(r([["ontouchstart"in window?"touchstart touchmove touchend":"pointerdown pointermove pointerup MSPointerDown MSPointerMove MSPointerUp",function(b){t.menuScrollTouch(a,b)}]],".smartmenus_scroll"))}}a.css({top:"auto",left:"0",marginLeft:d,marginTop:l-b});this.menuIframeShim(a);a.dataSM("ie-shim")&&a.dataSM("ie-shim").css({zIndex:a.css("z-index"),width:f,height:g,marginLeft:d,marginTop:l- b})},menuScroll:function(a,b,c){var d=a.dataSM("scroll"),f=a.dataSM("scroll-arrows"),g=parseFloat(a.css("margin-top")),h=d.up?d.upEnd:d.downEnd;if(!b&&d.velocity){if(d.velocity*=.9,c=d.velocity,.5>c){this.menuScrollStop(a);return}}else c=c||(b||!this.opts.scrollAccelerate?this.opts.scrollStep:Math.floor(d.step));var k=a.dataSM("level");this.visibleSubMenus.length>k&&this.menuHideSubMenus(k-1);g=d.up&&h<=g||!d.up&&h>=g?g:Math.abs(h-g)>c?g+(d.up?c:-c):h;a.add(a.dataSM("ie-shim")).css("margin-top",g); m&&(d.up&&g>d.downEnd||!d.up&&g<d.upEnd)&&f.eq(d.up?1:0).show();if(g==h)m&&f.eq(d.up?0:1).hide(),this.menuScrollStop(a);else if(!b){this.opts.scrollAccelerate&&d.step<this.opts.scrollStep&&(d.step+=.5);var n=this;this.scrollTimeout=setTimeout(function(){n.menuScroll(a)},this.opts.scrollInterval)}},menuScrollMousewheel:function(a,b){if(this.getClosestMenu(b.target)==a[0]){b=b.originalEvent;var c=0<(b.wheelDelta||-b.detail);a.dataSM("scroll-arrows").eq(c?0:1).is(":visible")&&(a.dataSM("scroll").up= c,this.menuScroll(a,!0))}b.preventDefault()},menuScrollOut:function(a,b){m&&(/^scroll-(up|down)/.test((b.relatedTarget||"").className)||(a[0]==b.relatedTarget||c.contains(a[0],b.relatedTarget))&&this.getClosestMenu(b.relatedTarget)==a[0]||a.dataSM("scroll-arrows").css("visibility","hidden"))},menuScrollOver:function(a,b){if(m&&!/^scroll-(up|down)/.test(b.target.className)&&this.getClosestMenu(b.target)==a[0]){this.menuScrollRefreshData(a);var c=a.dataSM("scroll");a.dataSM("scroll-arrows").eq(0).css("margin-top", c.upEnd).end().eq(1).css("margin-top",c.downEnd+c.subH-c.arrowDownH).end().css("visibility","visible")}},menuScrollRefreshData:function(a){var b=a.dataSM("scroll");a=c(window).scrollTop()-a.dataSM("parent-a").offset().top-b.itemH;c.extend(b,{upEnd:a,downEnd:a+this.getViewportHeight()-b.subH})},menuScrollStop:function(a){if(this.scrollTimeout)return clearTimeout(this.scrollTimeout),this.scrollTimeout=0,c.extend(a.dataSM("scroll"),{step:1,velocity:0}),!0},menuScrollTouch:function(a,b){b=b.originalEvent; if(!/^(4|mouse)$/.test(b.pointerType)){var e=this.getTouchPoint(b);if(this.getClosestMenu(e.target)==a[0]){var d=a.dataSM("scroll");if(/(start|down)$/i.test(b.type))this.menuScrollStop(a)?(b.preventDefault(),this.isTouchScrolling=!0):this.isTouchScrolling=!1,this.menuScrollRefreshData(a),c.extend(d,{touchY:e.pageY,touchTimestamp:b.timeStamp,velocity:0});else if(/move$/i.test(b.type)){var f=d.touchY;void 0!==f&&f!=e.pageY&&(this.isTouchScrolling=!0,c.extend(d,{up:f<e.pageY,touchY:e.pageY,touchTimestamp:b.timeStamp, velocity:d.velocity+.5*Math.abs(e.pageY-f)}),this.menuScroll(a,!0,Math.abs(d.touchY-f)));b.preventDefault()}else void 0!==d.touchY&&(120>b.timeStamp-d.touchTimestamp&&0<d.velocity&&(d.velocity*=.5,this.menuScrollStop(a),this.menuScroll(a),b.preventDefault()),delete d.touchY)}}},menuShow:function(a){if(!a.dataSM("beforefirstshowfired")&&(a.dataSM("beforefirstshowfired",!0),!1===this.$root.triggerHandler("beforefirstshow.smapi",a[0])))return;if(!1!==this.$root.triggerHandler("beforeshow.smapi",a[0])&& (this.menuFixLayout(a),a.stop(!0,!0),!a.is(":visible"))){a.css("z-index",this.zIndexInc=(this.zIndexInc||this.getStartZIndex())+1);(this.opts.keepHighlighted||this.isCollapsible())&&a.dataSM("parent-a").addClass("highlighted");if(this.opts.subMenusMinWidth||this.opts.subMenusMaxWidth)if(a.css({width:"",minWidth:"",maxWidth:""}).addClass("sm-nowrap"),this.opts.subMenusMinWidth&&a.css("min-width",this.opts.subMenusMinWidth),this.opts.subMenusMaxWidth){var b=this.getWidth(a);a.css("max-width",this.opts.subMenusMaxWidth); b>this.getWidth(a)&&a.removeClass("sm-nowrap").css("width",this.opts.subMenusMaxWidth)}this.menuPosition(a);a.dataSM("ie-shim")&&a.dataSM("ie-shim").insertBefore(a);b=function(){a.css("overflow","")};this.isCollapsible()?this.opts.collapsibleShowFunction?this.opts.collapsibleShowFunction.call(this,a,b):a.show(this.opts.collapsibleShowDuration,b):this.opts.showFunction?this.opts.showFunction.call(this,a,b):a.show(this.opts.showDuration,b);this.visibleSubMenus[a.dataSM("level")-1]=a;this.$root.triggerHandler("show.smapi", a[0])}},popupHide:function(a){this.hideTimeout&&(clearTimeout(this.hideTimeout),this.hideTimeout=0);var b=this;this.hideTimeout=setTimeout(function(){b.menuHideAll()},a?1:this.opts.hideTimeout)},popupShow:function(a,b){if(this.opts.isPopup){if(this.hideTimeout&&(clearTimeout(this.hideTimeout),this.hideTimeout=0),this.menuFixLayout(this.$root),this.$root.stop(!0,!0),!this.$root.is(":visible")){this.$root.css({left:a,top:b});this.menuIframeShim(this.$root);this.$root.dataSM("ie-shim")&&this.$root.dataSM("ie-shim").css({zIndex:this.$root.css("z-index"), width:this.getWidth(this.$root),height:this.getHeight(this.$root),left:a,top:b}).insertBefore(this.$root);var c=this,d=function(){c.$root.css("overflow","")};this.opts.showFunction?this.opts.showFunction.call(this,this.$root,d):this.$root.show(this.opts.showDuration,d);this.visibleSubMenus[0]=this.$root}}else alert('SmartMenus jQuery Error:\n\nIf you want to show this menu via the "popupShow" method, set the isPopup:true option.')},refresh:function(){this.menuHideAll();this.$root.find("ul").each(function(){var a= c(this);a.dataSM("scroll-arrows")&&a.dataSM("scroll-arrows").remove()}).removeDataSM("in-mega").removeDataSM("shown-before").removeDataSM("ie-shim").removeDataSM("scroll-arrows").removeDataSM("parent-a").removeDataSM("level").removeDataSM("beforefirstshowfired");this.$root.find("a.has-submenu").removeClass("has-submenu").parent().removeDataSM("sub");this.opts.subIndicators&&this.$root.find("span.sub-arrow").remove();this.opts.markCurrentItem&&this.$root.find("a.current").removeClass("current");this.subMenus= [];this.init(!0)},rootOut:function(a){if(this.handleEvents()&&!this.isTouchMode()&&a.target!=this.$root[0]&&(this.hideTimeout&&(clearTimeout(this.hideTimeout),this.hideTimeout=0),!this.opts.showOnClick||!this.opts.hideOnClick)){var b=this;this.hideTimeout=setTimeout(function(){b.menuHideAll()},this.opts.hideTimeout)}},rootOver:function(a){this.handleEvents()&&!this.isTouchMode()&&a.target!=this.$root[0]&&this.hideTimeout&&(clearTimeout(this.hideTimeout),this.hideTimeout=0)},winResize:function(a){this.handleEvents()? this.isCollapsible()||"onorientationchange"in window&&"orientationchange"!=a.type||(this.activatedItems.length&&this.activatedItems[this.activatedItems.length-1][0].blur(),this.menuHideAll()):this.$disableOverlay&&(a=this.$root.offset(),this.$disableOverlay.css({top:a.top,left:a.left,width:this.$root.outerWidth(),height:this.$root.outerHeight()}))}}});c.fn.dataSM=function(a,b){return b?this.data(a+"_smartmenus",b):this.data(a+"_smartmenus")};c.fn.removeDataSM=function(a){return this.removeData(a+ "_smartmenus")};c.fn.smartmenus=function(a){if("string"==typeof a){var b=arguments,e=a;Array.prototype.shift.call(b);return this.each(function(){var a=c(this).data("smartmenus");a&&a[e]&&a[e].apply(a,b)})}var d=c.extend({},c.fn.smartmenus.defaults,a);return this.each(function(){new c.SmartMenus(this,d)})};c.fn.smartmenus.defaults={isPopup:!1,mainMenuSubOffsetX:0,mainMenuSubOffsetY:0,subMenusSubOffsetX:0,subMenusSubOffsetY:0,subMenusMinWidth:"10em",subMenusMaxWidth:"auto",subIndicators:!0,subIndicatorsPos:"prepend", subIndicatorsText:"+",scrollStep:30,scrollInterval:30,scrollAccelerate:!0,showTimeout:250,hideTimeout:500,showDuration:0,showFunction:null,hideDuration:0,hideFunction:function(a,b){a.fadeOut(200,b)},collapsibleShowDuration:0,collapsibleShowFunction:function(a,b){a.slideDown(200,b)},collapsibleHideDuration:0,collapsibleHideFunction:function(a,b){a.slideUp(200,b)},showOnClick:!1,hideOnClick:!0,keepInViewport:!0,keepHighlighted:!0,markCurrentItem:!1,markCurrentTree:!0,rightToLeftSubMenus:!1,bottomToTopSubMenus:!1, overlapControlsInIE:!0}})(jQuery);
...
(function(e) {
  ...
  function n(a, b, c) {
    return b < a.length ? a : Array(b - a.length + 1).join(c || " ") + a;
  }
  function p() {
  ...
  u.prototype = {constructor:u, init:function(a, b) {
    var c;
    if (!b.pickTime && !b.pickDate) {
      throw Error("Must choose at least one picker");
    }
    this.options = b;
    this.$element = e(a);
    this.language = b.language in v ? b.language : "en";
    this.pickDate = b.pickDate;
    this.pickTime = b.pickTime;
    this.isInput = this.$element.is("input");
    this.component = !1;
    if (this.$element.find(".input-append") || this.$element.find(".input-prepend")) {
      this.component = this.$element.find(".label-add-on");
    }
    this.format = b.format;
    this.format || (this.format = this.isInput ? this.$element.data("format") : this.$element.find("input").data("format"), this.format || (this.format = "MM/dd/yyyy"));
    this._compileFormat();
    this.component && (c = this.component.find("i"));
    this.pickTime && (c && c.length && (this.timeIcon = c.data("fa fa-clock-o")), this.timeIcon || (this.timeIcon = "fa fa-clock-o"), c.addClass(this.timeIcon));
    this.pickDate && (c && c.length && (this.dateIcon = c.data("fa fa-calendar")), this.dateIcon || (this.dateIcon = "fa fa-calendar"), c.removeClass(this.timeIcon), c.addClass(this.dateIcon));
    c = b.pickTime;
    var d = b.pick12HourFormat, k = b.pickSeconds, l = b.collapse;
    c = b.pickDate && c ? '<div class="wi-datetimepicker-widget dropdown-menu"><ul><li' + (l ? ' class="collapse in"' : "") + '><div class="datepicker">' + h.template + '</div></li><li' + (l ? ' class="collapse"' : "") + '><div class="timepicker">' + t.getTemplate(d, k) + '</div></li><li class="picker-switch accordion-toggle"><a><i class="' + this.timeIcon + '"></i></a></li></ul></div>' : c ? '<div class="wi-datetimepicker-widget dropdown-menu"><div class="timepicker">' + t.getTemplate(d, k) + "</div></div>" : 
    '<div class="wi-datetimepicker-widget dropdown-menu"><div class="datepicker">' + h.template + "</div></div>";
    this.widget = e(c).appendTo("body");
    this.minViewMode = b.minViewMode || this.$element.data("date-minviewmode") || 0;
    if ("string" === typeof this.minViewMode) {
    ...
    if ("string" === typeof this.viewMode) {
    ...
    for (var a = this.widget.find(".collapse"), b = 0;b < a.length;b++) {
      var c = a.eq(b).data("collapse");
    ...
    var a = "";
    this._unset || (a = this.formatDate(this._date));
    if (this.isInput) {
      this.$element.val(a), this._resetMaskPos(this.$element);
    } else {
      if (this.component) {
        var b = this.$element.find("input");
        b.val(a);
        this._resetMaskPos(b);
      }
      this.$element.data("date", a);
    }
  }, setValue:function(a) {
    this._unset = a ? !1 : !0;
    "string" === typeof a ? this._date = this.parseDate(a) : a && (this._date = new Date(a));
    this.set();
    this.viewDate = p(this._date.getUTCFullYear(), this._date.getUTCMonth(), 1, 0, 0, 0, 0);
    this.fillDate();
    this.fillTime();
  }, getDate:function() {
    return this._unset ? null : new Date(this._date.valueOf());
  }, setDate:function(a) {
    a ? this.setValue(a.valueOf()) : this.setValue(null);
  }, setStartDate:function(a) {
    a instanceof Date ? this.startDate = a : "string" === typeof a ? (this.startDate = new p(a), this.startDate.getUTCFullYear() || (this.startDate = -Infinity)) : this.startDate = -Infinity;
    this.viewDate && this.update();
  }, setEndDate:function(a) {
    a instanceof Date ? this.endDate = a : "string" === typeof a ? (this.endDate = new p(a), this.endDate.getUTCFullYear() || (this.endDate = Infinity)) : this.endDate = Infinity;
    this.viewDate && this.update();
  ...
  }, setLocalDate:function(a) {
    a ? this.setValue(Date.UTC(a.getFullYear(), a.getMonth(), a.getDate(), a.getHours(), a.getMinutes(), a.getSeconds(), a.getMilliseconds())) : this.setValue(null);
  }, place:function() {
    var a = "absolute", b = this.component ? this.component.offset() : this.$element.offset();
    this.width = this.component ? this.component.outerWidth() : this.$element.outerWidth();
    b.top += this.height;
    var c = e(window);
    void 0 != this.options.width && this.widget.width(this.options.width);
    "left" == this.options.orientation && (this.widget.addClass("left-oriented"), b.left = b.left - this.widget.width() + 20);
    this._isInFixed() && (a = "fixed", b.top -= c.scrollTop(), b.left -= c.scrollLeft());
    c.width() < b.left + this.widget.outerWidth() ? (b.right = c.width() - b.left - this.width, b.left = "auto", this.widget.addClass("pull-right")) : (b.right = "auto", this.widget.removeClass("pull-right"));
    this.widget.css({position:a, top:b.top, left:b.left, right:b.right});
  }, notifyChange:function() {
    this.$element.trigger({type:"changeDate", date:this.getDate(), localDate:this.getLocalDate()});
  }, update:function(a) {
    if (!a) {
      if (a = this.isInput ? this.$element.val() : this.$element.find("input").val()) {
        this._date = this.parseDate(a);
      }
      this._date || (a = new Date, this._date = p(a.getFullYear(), a.getMonth(), a.getDate(), a.getHours(), a.getMinutes(), a.getSeconds(), a.getMilliseconds()));
    }
    this.viewDate = p(this._date.getUTCFullYear(), this._date.getUTCMonth(), 1, 0, 0, 0, 0);
    this.fillDate();
    this.fillTime();
  }, fillDow:function() {
    for (var a = this.weekStart, b = e("<tr>");a < this.weekStart + 7;) {
      b.append('<th class="dow">' + v[this.language].daysMin[a++ % 7] + "</th>");
    }
    this.widget.find(".datepicker-days thead").append(b);
  }, fillMonths:function() {
    for (var a = "", b = 0;12 > b;) {
      a += '<span class="month">' + v[this.language].monthsShort[b++] + "</span>";
    }
    this.widget.find(".datepicker-months td").append(a);
  }, fillDate:function() {
    var a = this.viewDate.getUTCFullYear(), b = this.viewDate.getUTCMonth(), c = p(this._date.getUTCFullYear(), this._date.getUTCMonth(), this._date.getUTCDate(), 0, 0, 0, 0), d = "object" === typeof this.startDate ? this.startDate.getUTCFullYear() : -Infinity, k = "object" === typeof this.startDate ? this.startDate.getUTCMonth() : -1, l = "object" === typeof this.endDate ? this.endDate.getUTCFullYear() : Infinity, x = "object" === typeof this.endDate ? this.endDate.getUTCMonth() : 12;
    this.widget.find(".datepicker-days").find(".disabled").removeClass("disabled");
    this.widget.find(".datepicker-months").find(".disabled").removeClass("disabled");
    this.widget.find(".datepicker-years").find(".disabled").removeClass("disabled");
    this.widget.find(".datepicker-days th:eq(1)").text(v[this.language].months[b] + " " + a);
    var g = p(a, b - 1, 28, 0, 0, 0, 0), m = h.getDaysInMonth(g.getUTCFullYear(), g.getUTCMonth());
    g.setUTCDate(m);
    g.setUTCDate(m - (g.getUTCDay() - this.weekStart + 7) % 7);
    (a == d && b <= k || a < d) && this.widget.find(".datepicker-days th:eq(0)").addClass("disabled");
    (a == l && b >= x || a > l) && this.widget.find(".datepicker-days th:eq(2)").addClass("disabled");
    var f = new Date(g.valueOf());
    f.setUTCDate(f.getUTCDate() + 42);
    for (var f = f.valueOf(), m = [], n, q;g.valueOf() < f;) {
      g.getUTCDay() === this.weekStart && (n = e("<tr>"), m.push(n));
      q = "";
      if (g.getUTCFullYear() < a || g.getUTCFullYear() == a && g.getUTCMonth() < b) {
        q += " old";
      } else {
        if (g.getUTCFullYear() > a || g.getUTCFullYear() == a && g.getUTCMonth() > b) {
          q += " new";
      ...
      g.valueOf() === c.valueOf() && (q += " active");
      g.valueOf() + 864E5 <= this.startDate && (q += " disabled");
      g.valueOf() > this.endDate && (q += " disabled");
      n.append('<td class="day' + q + '">' + g.getUTCDate() + "</td>");
      g.setUTCDate(g.getUTCDate() + 1);
    }
    this.widget.find(".datepicker-days tbody").empty().append(m);
    b = this._date.getUTCFullYear();
    m = this.widget.find(".datepicker-months").find("th:eq(1)").text(a).end().find("span").removeClass("active");
    b === a && m.eq(this._date.getUTCMonth()).addClass("active");
    b - 1 < d && this.widget.find(".datepicker-months th:eq(0)").addClass("disabled");
    b + 1 > l && this.widget.find(".datepicker-months th:eq(2)").addClass("disabled");
    for (c = 0;12 > c;c++) {
      a == d && k > c || a < d ? e(m[c]).addClass("disabled") : (a == l && x < c || a > l) && e(m[c]).addClass("disabled");
    }
    m = "";
    a = 10 * parseInt(a / 10, 10);
    k = this.widget.find(".datepicker-years").find("th:eq(1)").text(a + "-" + (a + 9)).end().find("td");
    this.widget.find(".datepicker-years").find("th").removeClass("disabled");
    d > a && this.widget.find(".datepicker-years").find("th:eq(0)").addClass("disabled");
    l < a + 9 && this.widget.find(".datepicker-years").find("th:eq(2)").addClass("disabled");
    --a;
    for (c = -1;11 > c;c++) {
      m += '<span class="year' + (-1 === c || 10 === c ? " old" : "") + (b === a ? " active" : "") + (a < d || a > l ? " disabled" : "") + '">' + a + "</span>", a += 1;
    }
    k.html(m);
  }, fillHours:function() {
    var a = this.widget.find(".timepicker .timepicker-hours table");
    a.parent().hide();
    var b = "";
    if (this.options.pick12HourFormat) {
      for (var c = 1, d = 0;3 > d;d += 1) {
        for (var b = b + "<tr>", k = 0;4 > k;k += 1) {
          var e = c.toString(), b = b + ('<td class="hour">' + n(e, 2, "0") + "</td>");
          c++;
        }
        b += "</tr>";
      }
      ...
      for (d = c = 0;6 > d;d += 1) {
        b += "<tr>";
        for (k = 0;4 > k;k += 1) {
          e = c.toString(), b += '<td class="hour">' + n(e, 2, "0") + "</td>", c++;
        }
        b += "</tr>";
      }
    }
    ...
    var a = this.widget.find(".timepicker .timepicker-minutes table");
    a.parent().hide();
    for (var b = "", c = 0, d = 0;5 > d;d++) {
      for (var b = b + "<tr>", e = 0;4 > e;e += 1) {
        b += '<td class="minute">' + n(c.toString(), 2, "0") + "</td>", c += 3;
      }
      b += "</tr>";
    }
    a.html(b);
  }, fillSeconds:function() {
    var a = this.widget.find(".timepicker .timepicker-seconds table");
    a.parent().hide();
    for (var b = "", c = 0, d = 0;5 > d;d++) {
      for (var b = b + "<tr>", e = 0;4 > e;e += 1) {
        b += '<td class="second">' + n(c.toString(), 2, "0") + "</td>", c += 3;
      }
      b += "</tr>";
    }
    a.html(b);
    ...
    if (this._date) {
      var a = this.widget.find(".timepicker span[data-time-component]");
      a.closest("table");
      var b = this.options.pick12HourFormat, c = this._date.getUTCHours(), d = "AM";
      b && (12 <= c && (d = "PM"), 0 === c ? c = 12 : 12 != c && (c %= 12), this.widget.find(".timepicker [data-action=togglePeriod]").text(d));
      c = n(c.toString(), 2, "0");
      b = n(this._date.getUTCMinutes().toString(), 2, "0");
      d = n(this._date.getUTCSeconds().toString(), 2, "0");
      a.filter("[data-time-component=hours]").text(c);
      a.filter("[data-time-component=minutes]").text(b);
      a.filter("[data-time-component=seconds]").text(d);
    }
  }, click:function(a) {
    a.stopPropagation();
    a.preventDefault();
      ...
      switch(a[0].nodeName.toLowerCase()) {
        case "th":
          switch(a[0].className) {
            ...
            ;
            case "next":
              var b = this.viewDate, c = h.modes[this.viewMode].navFnc, d = h.modes[this.viewMode].navStep;
              "prev" === a[0].className && (d *= -1);
              b["set" + c](b["get" + c]() + d);
              this.fillDate();
              this.set();
          }
          break;
        case "span":
          a.is(".month") ? (b = a.parent().find("span").index(a), this.viewDate.setUTCMonth(b)) : (c = parseInt(a.text(), 10) || 0, this.viewDate.setUTCFullYear(c));
          0 !== this.viewMode && (this._date = p(this.viewDate.getUTCFullYear(), this.viewDate.getUTCMonth(), this.viewDate.getUTCDate(), this._date.getUTCHours(), this._date.getUTCMinutes(), this._date.getUTCSeconds(), this._date.getUTCMilliseconds()), this.notifyChange());
          this.showMode(-1);
          this.fillDate();
          this.set();
          break;
        case "td":
          a.is(".day") && (d = parseInt(a.text(), 10) || 1, b = this.viewDate.getUTCMonth(), c = this.viewDate.getUTCFullYear(), a.is(".old") ? 0 === b ? (b = 11, --c) : --b : a.is(".new") && (11 == b ? (b = 0, c += 1) : b += 1), this._date = p(c, b, d, this._date.getUTCHours(), this._date.getUTCMinutes(), this._date.getUTCSeconds(), this._date.getUTCMilliseconds()), this.viewDate = p(c, b, Math.min(28, d), 0, 0, 0, 0), this.fillDate(), this.set(), this.notifyChange());
      }
    }
  }, actions:{incrementHours:function(a) {
    this._date.setUTCHours(this._date.getUTCHours() + 1);
  }, incrementMinutes:function(a) {
    this._date.setUTCMinutes(this._date.getUTCMinutes() + 1);
  }, incrementSeconds:function(a) {
    this._date.setUTCSeconds(this._date.getUTCSeconds() + 1);
  }, decrementHours:function(a) {
    this._date.setUTCHours(this._date.getUTCHours() - 1);
  }, decrementMinutes:function(a) {
    this._date.setUTCMinutes(this._date.getUTCMinutes() - 1);
  }, decrementSeconds:function(a) {
    this._date.setUTCSeconds(this._date.getUTCSeconds() - 1);
  }, togglePeriod:function(a) {
    a = this._date.getUTCHours();
    this._date.setUTCHours(12 <= a ? a - 12 : a + 12);
  }, showPicker:function() {
    ...
    this.options.pick12HourFormat && (12 <= this._date.getUTCHours() ? 12 != a && (a = (a + 12) % 24) : a = 12 === a ? 0 : a % 12);
    ...
    a.stopPropagation();
    a.preventDefault();
    this._date || (this._date = p(1970, 0, 0, 0, 0, 0, 0));
    var b = e(a.currentTarget).data("action"), b = this.actions[b].apply(this, arguments);
    this.set();
    this.fillTime();
    this.notifyChange();
    return b;
    ...
    var b = this, c = a.which, d = e(a.target);
    8 != c && 46 != c || setTimeout(function() {
      b._resetMaskPos(d);
    });
  }, keypress:function(a) {
    var b = a.which;
    if (8 != b && 46 != b) {
      a = e(a.target);
      var b = String.fromCharCode(b), c = a.val() || "", c = c + b, d = this._mask[this._maskPos];
      if (!d) {
        return !1;
      }
      if (d.end == c.length) {
        if (d.pattern.test(c.slice(d.start))) {
          this._maskPos++;
        } else {
          for (c = c.slice(0, c.length - 1);(d = this._mask[this._maskPos]) && d.character;) {
            c += d.character, this._maskPos++;
          }
          c += b;
          d.end != c.length ? a.val(c) : d.pattern.test(c.slice(d.start)) ? (a.val(c), this._maskPos++) : a.val(c.slice(0, d.start));
          return !1;
        }
      }
    }
    ...
    a = e(a.target);
    var b = a.val();
    this._formatPattern.test(b) ? (this.update(), this.setValue(this._date.getTime()), this.notifyChange(), this.set()) : b && b.trim() ? (this.setValue(this._date.getTime()), this._date ? this.set() : a.val("")) : this._date && (this.setValue(null), this.notifyChange(), this._unset = !0);
    this._resetMaskPos(a);
  }, showMode:function(a) {
    a && (this.viewMode = Math.max(this.minViewMode, Math.min(2, this.viewMode + a)));
    this.widget.find(".datepicker > div").hide().filter(".datepicker-" + h.modes[this.viewMode].clsName).show();
  }, destroy:function() {
    this._detachDatePickerEvents();
    this._detachDatePickerGlobalEvents();
    this.widget.remove();
    ...
    return this.format.replace(A, function(b) {
      var c, d = b.length;
      "ms" === b && (d = 1);
      b = r[b].property;
      if ("Hours12" === b) {
        b = a.getUTCHours(), 0 === b ? b = 12 : 12 !== b && (b %= 12);
      } else {
        if ("Period12" === b) {
          return 12 <= a.getUTCHours() ? "PM" : "AM";
        }
        c = "get" + b;
        b = a[c]();
      }
      "getUTCMonth" === c && (b += 1);
      "getUTCYear" === c && (b = b + 1900 - 2E3);
      return n(b.toString(), d, "0");
    });
  }, parseDate:function(a) {
    var b, c, d, e = {};
    if (!(a = this._formatPattern.exec(a))) {
      return null;
    }
    for (b = 1;b < a.length;b++) {
      if (c = this._propertiesByIndex[b]) {
        d = a[b], /^\d+$/.test(d) && (d = parseInt(d, 10)), e[c] = d;
      }
    }
    return this._finishParsingDate(e);
  }, _resetMaskPos:function(a) {
    a = a.val();
    for (var b = 0;b < this._mask.length;b++) {
      if (this._mask[b].end > a.length) {
        this._maskPos = b;
        break;
      } else {
        if (this._mask[b].end === a.length) {
  ...
  }, _finishParsingDate:function(a) {
    var b, c, d, e, l, f, g;
    b = a.UTCFullYear;
    a.UTCYear && (b = 2E3 + a.UTCYear);
    b || (b = 1970);
    c = a.UTCMonth ? a.UTCMonth - 1 : 0;
    d = a.UTCDate || 1;
    e = a.UTCHours || 0;
    l = a.UTCMinutes || 0;
    f = a.UTCSeconds || 0;
    g = a.UTCMilliseconds || 0;
    a.Hours12 && (e = a.Hours12);
    a.Period12 && (/pm/i.test(a.Period12) ? 12 != e && (e = (e + 12) % 24) : e %= 12);
    return p(b, c, d, e, l, f, g);
  }, _compileFormat:function() {
    for (var a, b = [], c = [], d = this.format, e = {}, f = 0, h = 0;a = B.exec(d);) {
      a = a[0], a in r ? (f++, e[f] = r[a].property, b.push("\\s*" + r[a].getPattern(this) + "\\s*"), c.push({pattern:new RegExp(r[a].getPattern(this)), property:r[a].property, start:h, end:h += a.length})) : (b.push(w(a)), c.push({pattern:new RegExp(w(a)), character:a, start:h, end:++h})), d = d.slice(a.length);
    }
    this._mask = c;
    this._maskPos = 0;
    this._formatPattern = new RegExp("^\\s*" + b.join("") + "\\s*$");
    this._propertiesByIndex = e;
    ...
    if (this.pickDate && this.pickTime) {
      this.widget.on("click.togglePicker", ".accordion-toggle", function(b) {
        b.stopPropagation();
        b = e(this);
        var c = b.closest("ul"), d = c.find(".collapse.in"), c = c.find(".collapse:not(.in)");
        if (d && d.length) {
          var f = d.data("collapse");
          f && f.transitioning || (d.collapse("hide"), c.collapse("show"), b.find("i").toggleClass(a.timeIcon + " " + a.dateIcon), a.$element.find(".label-add-on i").toggleClass(a.timeIcon + " " + a.dateIcon));
        }
      });
    }
    if (this.isInput) {
      if (this.$element.on({focus:e.proxy(this.show, this), change:e.proxy(this.change, this)}), this.options.maskInput) {
        this.$element.on({keydown:e.proxy(this.keydown, this), keypress:e.proxy(this.keypress, this)});
      }
    } else {
      this.$element.on({change:e.proxy(this.change, this)}, "input");
      if (this.options.maskInput) {
        this.$element.on({keydown:e.proxy(this.keydown, this), keypress:e.proxy(this.keypress, this)}, "input");
      }
      if (this.component) {
    ...
    this.isInput || e(document).off("mousedown.datetimepicker" + this.id);
  }, _isInFixed:function() {
    if (this.$element) {
      for (var a = this.$element.parents(), b = !1, c = 0;c < a.length;c++) {
        if ("fixed" == e(a[c]).css("position")) {
          b = !0;
          break;
        }
      }
  ...
  e.fn.datetimepicker = function(a, b) {
    return this.each(function() {
      var c = e(this), d = c.data("datetimepicker"), f = "object" === typeof a && a;
  ...
  e.fn.datetimepicker.defaults = {maskInput:!1, pickDate:!0, pickTime:!0, pick12HourFormat:!1, pickSeconds:!0, startDate:-Infinity, endDate:Infinity, collapse:!0};
  e.fn.datetimepicker.Constructor = u;
  var z = 0, v = e.fn.datetimepicker.dates = {en:{days:"Sunday Monday Tuesday Wednesday Thursday Friday Saturday Sunday".split(" "), daysShort:"Sun Mon Tue Wed Thu Fri Sat Sun".split(" "), daysMin:"Su Mo Tu We Th Fr Sa Su".split(" "), months:"January February March April May June July August September October November December".split(" "), monthsShort:"Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" ")}}, r = {dd:{property:"UTCDate", getPattern:function() {
  ...
  f[f.length - 1] += "\\b";
  f.push(".");
  var B = new RegExp(f.join("\\b|"));
  f.pop();
  var A = new RegExp(f.join("\\b|"), "g"), h = {modes:[{clsName:"days", navFnc:"UTCMonth", navStep:1}, {clsName:"months", navFnc:"UTCFullYear", navStep:1}, {clsName:"years", navFnc:"UTCFullYear", navStep:10}], isLeapYear:function(a) {
    return 0 === a % 4 && 0 !== a % 100 || 0 === a % 400;
  }, getDaysInMonth:function(a, b) {
    return [31, h.isLeapYear(a) ? 29 : 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31][b];
  }, headTemplate:'<thead><tr><th class="prev"><i class="fa fa-angle-left"></i></th><th colspan="5" class="switch"></th><th class="next"><i class="fa fa-angle-right"></i></th></tr></thead>', contTemplate:'<tbody><tr><td colspan="7"></td></tr></tbody>'};
  h.template = '<div class="datepicker-days"><table class="table-condensed">' + h.headTemplate + '<tbody></tbody></table></div><div class="datepicker-months"><table class="table-condensed">' + h.headTemplate + h.contTemplate + '</table></div><div class="datepicker-years"><table class="table-condensed">' + h.headTemplate + h.contTemplate + "</table></div>";
  var t = {hourTemplate:'<span data-action="showHours" data-time-component="hours" class="timepicker-hour"></span>', minuteTemplate:'<span data-action="showMinutes" data-time-component="minutes" class="timepicker-minute"></span>', secondTemplate:'<span data-action="showSeconds" data-time-component="seconds" class="timepicker-second"></span>', getTemplate:function(a, b) {
    return '<div class="timepicker-picker"><table class="table-condensed"' + (a ? ' data-hour-format="12"' : "") + '><tr><td><a href="#" class="wi-btn" data-action="incrementHours"><i class="fa fa-chevron-up"></i></a></td><td class="separator"></td><td><a href="#" class="wi-btn" data-action="incrementMinutes"><i class="fa fa-chevron-up"></i></a></td>' + (b ? '<td class="separator"></td><td><a href="#" class="wi-btn" data-action="incrementSeconds"><i class="fa fa-chevron-up"></i></a></td>' : "") + 
    (a ? '<td class="separator"></td>' : "") + "</tr><tr><td>" + t.hourTemplate + '</td> <td class="separator">:</td><td>' + t.minuteTemplate + "</td> " + (b ? '<td class="separator">:</td><td>' + t.secondTemplate + "</td>" : "") + (a ? '<td class="separator"></td><td><button type="button" class="wi-btn btn-primary" data-action="togglePeriod"></button></td>' : "") + '</tr><tr><td><a href="#" class="wi-btn" data-action="decrementHours"><i class="fa fa-chevron-down"></i></a></td><td class="separator"></td><td><a href="#" class="wi-btn" data-action="decrementMinutes"><i class="fa fa-chevron-down"></i></a></td>' + 
    (b ? '<td class="separator"></td><td><a href="#" class="wi-btn" data-action="decrementSeconds"><i class="fa fa-chevron-down"></i></a></td>' : "") + (a ? '<td class="separator"></td>' : "") + '</tr></table></div><div class="timepicker-hours" data-action="selectHour"><table class="table-condensed"></table></div><div class="timepicker-minutes" data-action="selectMinute"><table class="table-condensed"></table></div>' + (b ? '<div class="timepicker-seconds" data-action="selectSecond"><table class="table-condensed"></table></div>' : 
    "");
  }};
})(window.jQuery);
...
this));else if("manual"!=c){var f="hover"==c?"mouseleave":"focusout";this.$element.on(("hover"==c?"mouseenter":"focusin")+"."+this.type,this.options.selector,e.proxy(this.enter,this));this.$element.on(f+"."+this.type,this.options.selector,e.proxy(this.leave,this))}this.options.selector?this._options=e.extend({},this.options,{trigger:"manual",selector:""}):this.fixTitle()};d.prototype.getDefaults=function(){return d.DEFAULTS};d.prototype.getOptions=function(b){b=e.extend({},this.getDefaults(),this.$element.data(),
...
b?{top:a.top+a.height,left:a.left+a.width/2-c/2}:"top"==b?{top:a.top-d,left:a.left+a.width/2-c/2}:"left"==b?{top:a.top+a.height/2-d/2,left:a.left-c}:{top:a.top+a.height/2-d/2,left:a.left+a.width}};d.prototype.getViewportAdjustedDelta=function(b,a,c,d){var e={top:0,left:0};if(!this.$viewport)return e;var h=this.options.viewport&&this.options.viewport.padding||0,g=this.getPosition(this.$viewport);/right|left/.test(b)?(c=a.top-h-g.scroll,a=a.top+h-g.scroll+d,c<g.top?e.top=g.top-c:a>g.top+g.height&&(e.top=
g.top+g.height-a)):(d=a.left-h,a=a.left+h+c,d<g.left?e.left=g.left-d:a>g.width&&(e.left=g.left+g.width-a));return e};d.prototype.getTitle=function(){var b=this.$element,a=this.options;return b.attr("data-original-title")||("function"==typeof a.title?a.title.call(b[0]):a.title)};d.prototype.getUID=function(b){do b+=~~(1E6*Math.random());while(document.getElementById(b));return b};d.prototype.tip=function(){return this.$tip=this.$tip||e(this.options.template)};d.prototype.arrow=function(){return this.$arrow=
...
this.hide(function(){b.$element.off("."+b.type).removeData("bs."+b.type)})};var n=e.fn.tooltip;e.fn.tooltip=function(b){return this.each(function(){var a=e(this),c=a.data("bs.tooltip"),f="object"==typeof b&&b;if(c||!/destroy|hide/.test(b))if(c||a.data("bs.tooltip",c=new d(this,f)),"string"==typeof b)c[b]()})};e.fn.tooltip.Constructor=d;e.fn.tooltip.noConflict=function(){e.fn.tooltip=n;return this}}(jQuery);
